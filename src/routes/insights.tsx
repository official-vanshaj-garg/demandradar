  ...
  head: () => ({
    meta: [
      { title: "Insights / DemandRadar" },
      {
        name: "description",
        content:
          "Deterministic local-demo clusters and opportunity views for Bengaluru sample data and reports saved in this browser.",
      },
    ],
  }),
  component: Insights,
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
        Deterministic local-demo clustering over sample data and reports saved in this browser. No
        production AI model is connected.
      </p>
          ...
          {insightsViewModel.clusters.map((c) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-1 text-[11px] text-muted-foreground">{c.originLabel}</div>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-primary/40 bg-primary/[0.05] p-4">
            ...
            <p className="mt-2 text-sm">
              ...
              {insightsViewModel.activeClusterCount} active clusters / ranked by deterministic demo
              scores / routed to recommended actors with concrete suggested actions.
            </p>
