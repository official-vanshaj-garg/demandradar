      ...
      <section className="mx-auto mt-16 grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[1.2fr_1fr]">
        ...
        <div className="rounded-2xl border border-border bg-glass p-6 glass">
          ...
          <h3 className="mt-1 font-display text-xl font-semibold">
            14 hyperlocal demand categories
          </h3>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <Step
            n={2}
            title="Structure"
            body="The intelligence layer structures reports into typed Demand Cards with category, urgency, signal strength, and confidence."
          />
          <Step
            n={3}
            title="Act"
            body="Demand Cards cluster on the map and surface in the Intelligence Dashboard with recommended actors and actions."
          />
        </div>
      </section>
      ...
      <section className="mx-auto mt-20 max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <UseCase
            ...
            body="See validated, geo-tagged demand before opening."
          />
          <UseCase
            icon={Users}
            label="NGOs"
...
function Problem({ icon: Icon, title, body }: { icon: LucideIcon; title: string; body: string }) {
  return (
...
function UseCase({ icon: Icon, label, body }: { icon: LucideIcon; label: string; body: string }) {
  return (
